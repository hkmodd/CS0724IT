...
- ### 🚀 Tracce
  - [📌 Giorno 1: SQL Injection su DVWA (Low e Medium)](#-giorno-1-sql-injection-su-dvwa-low-e-medium)
  - [📌 Giorno 2: Exploit XSS Persistente su DVWA (Low e Medium)](#-giorno-2-exploit-xss-persistente-su-dvwa-low-e-medium)
  - [📌 Giorno 3: Programma in C](#-giorno-3-programma-in-c)
  - [📌 Giorno 4: Sfruttamento di Vulnerabilità sulla Macchina Metasploitable](#-giorno-4-sfruttamento-di-vulnerabilità-sulla-macchina-metasploitable)
  - [📌 Giorno 5: Exploit di Windows 10 con Metasploit](#-giorno-5-exploit-di-windows-10-con-metasploit)
