...
# 4️⃣ CATTIVERIA PURA **Uso dell'Exploit PwnKit (CVE-2021-4034)**
...
3. Scoperta e accesso a WordPress per ottenere una **reverse shell**.
4. Trasferimento ed esecuzione dell'exploit **PwnKit** per ottenere root access.
